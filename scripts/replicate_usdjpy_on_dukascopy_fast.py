...
from scripts.replicate_usdjpy_on_dukascopy import MAX_WORKERS, _hour_url, build_candidate_rows, decode_hour, fetch_bytes, load_h10_release_values, summarize
...
def load_quotes(rows: list, latencies: list[int]):
    ...
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
        ...
        for future in as_completed(futures):
            ...
            if error: errors[day.isoformat()] = error
            else: buckets[day] = (ticks, url, sha)
