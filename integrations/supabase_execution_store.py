...
class SupabaseExecutionStore:
    ...
    def active_orders(self) -> tuple[InternalOrderTruth, ...]:
        ...
        return tuple(
            InternalOrderTruth(
                ...
                state=str(row["state"]),
                filled_quantity=self._decimal(row.get("filled_quantity", "0")),
            )
            for row in rows
    ...
    def record_snapshot(self, snapshot: BrokerSnapshot) -> None:
        ...
        self._request(
            ...
            body={
                ...
                "correlation_id": self.environment,
                "payload": payload,
    ...
    def record_outcome(self, outcome: ReconciliationOutcome) -> None:
        ...
        self._request(
            ...
            body={
                ...
                "fills_checked": 0,
                "positions_checked": len(outcome.position_drift),
    ...
    def set_frozen(self, frozen: bool, reason: str | None = None) -> None:
        self._request(
            ...
            body={"environment": self.environment, "frozen": bool(frozen), "reason": reason},
